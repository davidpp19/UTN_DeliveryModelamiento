...
namespace Delivery.Modelos.Migrations
{
    ...
    [Migration("20260719200827_UpdateModelsForUML")]
    partial class UpdateModelsForUML
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Delivery.Modelos.Entidades.Carrito", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Delivery.Modelos.Entidades.CarritoItem", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Delivery.Modelos.Entidades.Cupon", b =>
                {
                    ...
                    b.Property<long?>("UsuarioExclusivoId")
                        .HasColumnType("bigint")
                        .HasColumnName("usuario_exclusivo_id");
            ...
            modelBuilder.Entity("Delivery.Modelos.Entidades.Usuario", b =>
                {
                    ...
                    b.Property<DateTime?>("ExpiracionCodigo")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("expiracion_codigo");
            ...
            modelBuilder.Entity("Delivery.Modelos.Entidades.CarritoItem", b =>
                {
                    b.HasOne("Delivery.Modelos.Entidades.Carrito", "Carrito")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("Delivery.Modelos.Entidades.Cupon", b =>
                {
                    ...
                    b.HasOne("Delivery.Modelos.Entidades.Usuario", "UsuarioExclusivo")
                        .WithMany()
                        .HasForeignKey("UsuarioExclusivoId");

                    b.Navigation("Restaurante");

                    b.Navigation("UsuarioExclusivo");
                });

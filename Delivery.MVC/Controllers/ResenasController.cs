...
namespace Delivery.MVC.Controllers
{
    public class ResenasController : Controller
    {
        ...
        public ResenasController(IResenaConsumer consumer)
        {
            _consumer = consumer;
        }
        ...
        [HttpPost]
        public async Task<IActionResult> Create(Resena entity)
        {
        ...
        [HttpPost]
        public async Task<IActionResult> Edit(long id, Resena entity)
        {
